    ...
    implements ObjectLayer
{
    ...
    public Person findEstablishedBy(Club club) throws ClubsException
    {
        return persistence.restoreEstablishedBy( club );
    }

    public void createEstablishedBy( Club club, Person person )
            throws ClubsException
    {
        persistence.saveEstablishedBy( club, person );
    }
    
    public Iterator<Club> findEstablishedBy( Person person )
            throws ClubsException
    {
        return persistence.restoreEstablishedBy( person );
    }
