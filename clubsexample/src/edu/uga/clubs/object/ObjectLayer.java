...
public interface ObjectLayer {
    ...
    public void                       createEstablishedBy( Club club, Person person ) throws ClubsException;
    public Person                     findEstablishedBy( Club club ) throws ClubsException;
    public Iterator<Club>             findEstablishedBy( Person person ) throws ClubsException;
    // the delete method should not be provided -- a Club must have a founder (the multiplicity is 1)
    //public void                       deleteEstablishedBy( Club club, Person person ) throws ClubsException;
